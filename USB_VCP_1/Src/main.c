...
/**
  ...
  *                             www.st.com/SLA0044
	* в файле usbd_cdc.h заменил #define CDC_DATA_HS_MAX_PACKET_SIZE   512U заменил на 256
	* в файле usbd_cdc_if.c заменил #define APP_RX_DATA_SIZE  4 на 64
 	* подключил с h - файла #include "usbd_cdc_if.h"
